...
HD_PWD='/home/moafk/Documents/FPGA/Kria_Projects/SPI-Sensor-VHDL/spi_light_sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ambient_light_sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ambient_light_sensor.tcl
