...
HD_PWD='/home/moafk/Documents/FPGA/Kria_Projects/SPI-Sensor-VHDL/spi_light_sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ambient_light_sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ambient_light_sensor.tcl -notrace
